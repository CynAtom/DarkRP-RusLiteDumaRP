...
GM.Config.maxlotterycost    = 10000000
...
-- Список тех оружий которых нельзя выкидывать (/drop)
...
-- Список вещей которые даются при спавне игрока
...
GM.Config.hudText = "Киллер.\nНажмие E что бы сделать заказ."
...
GM.Config.hitTargetCooldown = 100
